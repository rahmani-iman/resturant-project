  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.cardContainer}>
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("ایرانی"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("فست‌فود"))}
        >
        ...
        <Link
          className={style.card}
          onClick={() => dispatch(setInputValue("کباب"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("پیتزا"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("برگر"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("ساندویچ"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("سوخاری"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("پاستا"))}
        >
        ...
        <Link
          to="/SelectedResturants"
          className={style.card}
          onClick={() => dispatch(setInputValue("سالاد"))}
        >
