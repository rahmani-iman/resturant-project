...
const SearchedResturants = () => {
    ...
    const searchedData = matchesOnName.resturants.length ? matchesOnName : matchesOnCategory ;

    return (
        <div className={style.container}>
            <ResturantsPage loading={loading} data={searchedData} error={error} isSearched={true}/>
        </div>
    );
};
